...
# - Verifică dacă eroarea e displayed
    ...
    def test_error_login1(self):
        ...
        self.assertEqual(expected, actual.text, f'Mesajul asteptat {expected} e diferit de mesajul afisat {actual.text}.')
...
# incorrect')
    ...
    def test_error_login2(self):
        ...
        actual = self.driver.find_element(By.CLASS_NAME, "flash.error").text #(By.CSS_SELECTOR, 'div#flash.flash.error')(By.CLASS_NAME, "flash.error")
